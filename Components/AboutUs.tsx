	...
	return (
		<OuterDev2>
			<div className="container pt-6 pl-6 mx-auto space-y-5 lg:grid lg:grid-cols-12 lg:pl-0 ">
				{/* left section */}
				<div className=' divide-x  divide-blue-500 space-y-7 lg:col-span-7'>
					<h1 className='font-bold text-7xl text-center lg:text-left '>Our Story</h1>
					<p className='text-gray-400 w-1/2 pl-5'>
				...
				{/* right section */}
				<div className="divide-y divide-dashed text-4xl space-y-11 text-gray-400 lg:col-span-5">
					<div>01
